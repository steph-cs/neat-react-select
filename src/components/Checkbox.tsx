    ...
    <label htmlFor={checkboxId} className="inline-flex items-center gap-2 cursor-pointer select-none">
      <span className="relative inline-flex items-center justify-center w-5 h-5">
        <input
          ...
          {...props}
        />
        <span className={`w-5 h-5 rounded border-2 transition-all duration-150 peer-focus-visible:ring-2 peer-focus-visible:ring-ring peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-background flex items-center justify-center ${
          props.checked || indeterminate ? "border-primary bg-primary" : "border-muted-foreground/40 bg-background"
        }`}>
